...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('params',default_value=PathJoinSubstitution([pkg_dis_tutorial5, 'config', 'slam.yaml']), description='Path to the SLAM Toolbox configuration file')
]
